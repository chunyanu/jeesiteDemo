...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/test2/demoClass/">班级信息管理列表</a></li>
		<li class="active"><a href="${ctx}/test2/demoClass/form?id=${demoClass.id}">班级信息管理<shiro:hasPermission name="test2:demoClass:edit">${not empty demoClass.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="test2:demoClass:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="demoClass" action="${ctx}/test2/demoClass/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
				...
				<div class="controls">
					<table id="contentTable" class="table table-striped table-bordered table-condensed">
						<thead>
							<tr>
								...
								<th>stu_sex</th>
								<th>stu_age</th>
								<shiro:hasPermission name="test2:demoClass:edit"><th width="10">&nbsp;</th></shiro:hasPermission>
							</tr>
						</thead>
						<tbody id="demoStuInfoList">
						</tbody>
						<shiro:hasPermission name="test2:demoClass:edit"><tfoot>
					...
					<script type="text/template" id="demoStuInfoTpl">//<!--
						<tr id="demoStuInfoList{{idx}}">
							...
							<shiro:hasPermission name="test2:demoClass:edit"><td class="text-center" width="10">
		...
		<div class="form-actions">
			<shiro:hasPermission name="test2:demoClass:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
